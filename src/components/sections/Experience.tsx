  ...
  return (
    <section id="experience" className="relative z-10 px-4 py-24 md:px-8">
      <div className="mx-auto max-w-4xl">
        ...
        >
          <h2 className="mb-4 text-3xl font-bold text-white md:text-5xl">Experience & Training</h2>
        </motion.div>

        <div className="relative ml-3 space-y-12 border-l border-white/10 md:ml-6">
          {EXPERIENCE.map((exp, idx) => (
            ...
            >
              ...
              <div className="bg-primary border-background absolute top-1 -left-[9px] h-4 w-4 rounded-full border-2 shadow-[0_0_15px_rgba(255,45,120,0.8)]"></div>
